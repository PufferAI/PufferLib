...
import pufferlib
from pufferlib.ocean.minatar_freeway import binding


class MinAtarFreeway(pufferlib.PufferEnv):
    def __init__(
        self,
        num_envs=1,
        render_mode=None,
        ...
        self.single_observation_space = gymnasium.spaces.Box(
            low=0, high=1, shape=(10 * 10 * 7,), dtype=np.uint8
        )
...
if __name__ == "__main__":
    ...
    print("MinAtar Freeway SPS:", int(steps / (time.time() - start)))
