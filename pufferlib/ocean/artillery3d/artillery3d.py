...
class Artillery3D(pufferlib.PufferEnv):
    def __init__(self, num_envs=1, render_mode=None,
                 frameskip=1, x_size=2000, y_size=2000, z_size=2000,
                 target_min_x=600, target_max_x=1230, target_min_y=300, target_max_y=670, target_min_z=300, target_max_z=670,
        ...
        for i in range(num_envs):
            env_id = binding.env_init(
                ...
                seed, num_envs=num_envs, seed=seed, frameskip=frameskip, x_size=x_size, y_size=y_size, z_size=z_size,
