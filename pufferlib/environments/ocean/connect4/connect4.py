...
class MyConnect4(pufferlib.PufferEnv):
    def __init__(self, num_envs=1, render_mode=None, report_interval=128,
             width=672, height=576, piece_width=96, piece_height=96, longest_connected=0):
        super().__init__()
    ...
    def reset(self, seed=None):
        ...
        for i in range(self.num_envs):
            ...
            self.c_envs.append(CyConnect4(self.actions[i:i+1],
                ...
                self.width, self.height, self.piece_width, self.piece_height, self.longest_connected))
            self.c_envs[i].reset()
