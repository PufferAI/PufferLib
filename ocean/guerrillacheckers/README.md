...
The standalone client and tournament preserve the original Puffer 40 for
comparison with the current genuine two-sided 5c model.
...
| `guerrillacheckers_5c_twosided.bin` | Current two-sided 5c model | `9092cb9169c7ab702f31e8f4d9227e8d51d1dc3fd690de4c7ef0498893c4c60b` |
...
historical opponent, and an all-zero action mask identifies whichever slot is
waiting for its turn. Twenty percent of environments use the historical bank.
Opponent swaps happen only after all tagged games reach an episode boundary.
...
GAE and PPO. It defaults off for other environments.
...
930-70 as Guerrilla and 918-82 as COIN.
...
| Guerrilla / COIN | Random | Greedy | Puffer 40 | MCTS 2K | MCTS 10K | Puffer 5c |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Random | 8-92 | 0-100 | 0-100 | 0-100 | 0-100 | 0-100 |
| Greedy | 98-2 | 33-67 | 1-99 | 0-100 | 0-100 | 0-100 |
| Puffer 40 | 96-4 | 99-1 | 15-85 | 12-88 | 9-91 | 4-96 |
